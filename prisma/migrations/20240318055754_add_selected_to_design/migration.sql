...
INSERT INTO "new_Design" ("artboardId", "createdAt", "id", "layerId", "nextId", "ownerId", "prevId", "type", "visible") SELECT "artboardId", "createdAt", "id", "layerId", "nextId", "ownerId", "prevId", "type", "visible" FROM "Design";
DROP TABLE "Design";
