/*
  ...
  - You are about to drop the column `slug` on the `Asset` table. All the data in the column will be lost.
...
INSERT INTO "new_Asset" ("artworkId", "artworkVersionId", "attributes", "blob", "createdAt", "description", "id", "layerId", "name", "ownerId", "projectId", "type", "updatedAt") SELECT "artworkId", "artworkVersionId", "attributes", "blob", "createdAt", "description", "id", "layerId", "name", "ownerId", "projectId", "type", "updatedAt" FROM "Asset";
DROP TABLE "Asset";
