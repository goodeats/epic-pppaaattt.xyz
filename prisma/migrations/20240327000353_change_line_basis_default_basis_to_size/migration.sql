...
CREATE TABLE "new_Line" (
    ...
    "basis" TEXT NOT NULL DEFAULT 'size',
...
INSERT INTO "new_Line" ("basis", "createdAt", "designId", "format", "id", "updatedAt", "width") SELECT "basis", "createdAt", "designId", "format", "id", "updatedAt", "width" FROM "Line";
DROP TABLE "Line";
