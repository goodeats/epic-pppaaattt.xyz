...
INSERT INTO "new_ArtworkVersion" ("background", "branchId", "createdAt", "description", "height", "id", "name", "nextId", "ownerId", "prevId", "published", "publishedAt", "slug", "starred", "updatedAt", "width") SELECT "background", "branchId", "createdAt", "description", "height", "id", "name", "nextId", "ownerId", "prevId", "published", "publishedAt", "slug", "starred", "updatedAt", "width" FROM "ArtworkVersion";
