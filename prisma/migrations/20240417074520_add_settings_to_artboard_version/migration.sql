...
INSERT INTO "new_ArtboardVersion" ("artboardId", "branchId", "createdAt", "description", "id", "latest", "name", "nextId", "ownerId", "prevId", "slug", "updatedAt") SELECT "artboardId", "branchId", "createdAt", "description", "id", "latest", "name", "nextId", "ownerId", "prevId", "slug", "updatedAt" FROM "ArtboardVersion";
