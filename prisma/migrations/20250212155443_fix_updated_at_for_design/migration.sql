...
INSERT INTO "new_Design" ("artworkVersionId", "attributes", "createdAt", "id", "layerId", "nextId", "ownerId", "prevId", "selected", "type", "updatedAt", "visible") SELECT "artworkVersionId", "attributes", "createdAt", "id", "layerId", "nextId", "ownerId", "prevId", "selected", "type", "updatedAt", "visible" FROM "Design";
DROP TABLE "Design";
