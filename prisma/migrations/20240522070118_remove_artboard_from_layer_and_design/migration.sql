/*
  ...
  - You are about to drop the column `artboardId` on the `Design` table. All the data in the column will be lost.
  - You are about to drop the column `artboardId` on the `Layer` table. All the data in the column will be lost.
...
INSERT INTO "new_Design" ("artboardVersionId", "createdAt", "id", "layerId", "nextId", "ownerId", "prevId", "selected", "type", "visible") SELECT "artboardVersionId", "createdAt", "id", "layerId", "nextId", "ownerId", "prevId", "selected", "type", "visible" FROM "Design";
DROP TABLE "Design";
...
INSERT INTO "new_Layer" ("artboardVersionId", "createdAt", "description", "id", "name", "nextId", "ownerId", "parentId", "prevId", "selected", "slug", "updatedAt", "visible") SELECT "artboardVersionId", "createdAt", "description", "id", "name", "nextId", "ownerId", "parentId", "prevId", "selected", "slug", "updatedAt", "visible" FROM "Layer";
DROP TABLE "Layer";
