/*
  ...
  - You are about to drop the column `artboardId` on the `ArtboardVersion` table. All the data in the column will be lost.
  - You are about to drop the column `latest` on the `ArtboardVersion` table. All the data in the column will be lost.
...
INSERT INTO "new_ArtboardVersion" ("background", "branchId", "createdAt", "description", "height", "id", "name", "nextId", "ownerId", "prevId", "slug", "updatedAt", "width") SELECT "background", "branchId", "createdAt", "description", "height", "id", "name", "nextId", "ownerId", "prevId", "slug", "updatedAt", "width" FROM "ArtboardVersion";
