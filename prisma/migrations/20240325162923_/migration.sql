/*
  ...
  - You are about to drop the column `selectedDesigns` on the `Artboard` table. All the data in the column will be lost.
  - You are about to drop the column `selectedDesigns` on the `Layer` table. All the data in the column will be lost.
