...
CREATE TABLE "new_ArtworkVersion" (
    ...
    "watermarkColor" TEXT NOT NULL DEFAULT '000000',
...
INSERT INTO "new_ArtworkVersion" ("background", "branchId", "createdAt", "description", "height", "id", "name", "nextId", "ownerId", "prevId", "published", "publishedAt", "slug", "starred", "updatedAt", "watermark", "width") SELECT "background", "branchId", "createdAt", "description", "height", "id", "name", "nextId", "ownerId", "prevId", "published", "publishedAt", "slug", "starred", "updatedAt", "watermark", "width" FROM "ArtworkVersion";
