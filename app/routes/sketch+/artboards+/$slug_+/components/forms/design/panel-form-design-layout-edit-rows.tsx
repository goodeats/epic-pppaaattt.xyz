...
export const PanelFormDesignLayoutEditRows = ({
	layout,
}: {
	layout: ILayout
}) => {
	...
	const [form, fields] = useForm({
		id: `panel-form-design-layout-edit-${layout.id}-rows`,
		constraint: getFieldsetConstraint(EditDesignLayoutRowsSchema),
	...
	return (
		...
		>
			...
			<input
				type="hidden"
				name="intent"
				value={DESIGN_LAYOUT_INTENT.updateDesignLayoutRows}
			/>
			<Input
				type="number"
				min={1}
