...
export const PanelFormDesignFillEditBasis = ({ fill }: { fill: IFill }) => {
	const fetcher = useFetcher<typeof action>()
	const actionData = useActionData<typeof action>()
	const isPending = useIsPending()

	const [form, fields] = useForm({
		id: `panel-form-design-fill-edit-${fill.id}-basis`,
		constraint: getFieldsetConstraint(EditDesignFillBasisSchema),
	...
	return (
		...
		>
			...
			<input
				type="hidden"
				name="intent"
				value={DESIGN_FILL_INTENT.updateDesignFillBasis}
			/>
			<Select
