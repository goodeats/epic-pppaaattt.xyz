...
export const artworkLoaderRoute =
	'routes/editor+/projects+/$projectSlug_+/artworks+/$artworkSlug+/route'
...
export const meta: MetaFunction<typeof loader> = ({ params, matches }) => {
	...
	return [
		{ title: `${artworkName} | ${projectName} | Editor | XYZ` },
		{
			name: 'description',
			content: `Editor dashboard for artwork project: ${artworkName} (${projectName})`,
		},
	]
}
