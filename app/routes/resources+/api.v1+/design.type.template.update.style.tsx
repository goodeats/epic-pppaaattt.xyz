...
export const DesignTypeTemplateStyle = ({
	...
	const formId = `design-type-template-update-style-${designId}-${templateId}${
		formLocation ? `-${formLocation}` : ''
	}`
	const options = Object.values(TemplateStyleTypeEnum).map(typeEnum => ({
